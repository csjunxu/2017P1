...
getData = @() loadImagePatches(trainPATH,[patch_size,patch_size],1e5)/255;
...
net = trainGMMGatingNet_CN(GMM,net,getData,testCleanData,testNoisyData,4000,'GatingNet_knnNI2BS500_1e5_2e5_4000');
net = trainGMMGatingNet_CN(GMM,net,getData,testCleanData,testNoisyData,5000,'GatingNet_knnNI2BS500_1e5_2e5_5000'); 