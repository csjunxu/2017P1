...
getData = @() loadImagePatches(trainPATH,[patch_size,patch_size],5e4)/255;
...
net = trainGMMGatingNet_CN(GMM,net,getData,testCleanData,testNoisyData,1500,'GatingNet_knnNI2BS500_5e4_1e5_1500'); 
net = trainGMMGatingNet_CN(GMM,net,getData,testCleanData,testNoisyData,2000,'GatingNet_knnNI2BS500_5e4_1e5_2000'); 
net = trainGMMGatingNet_CN(GMM,net,getData,testCleanData,testNoisyData,3000,'GatingNet_knnNI2BS500_5e4_1e5_3000'); 
net = trainGMMGatingNet_CN(GMM,net,getData,testCleanData,testNoisyData,4000,'GatingNet_knnNI2BS500_5e4_1e5_4000');
net = trainGMMGatingNet_CN(GMM,net,getData,testCleanData,testNoisyData,5000,'GatingNet_knnNI2BS500_5e4_1e5_5000'); 